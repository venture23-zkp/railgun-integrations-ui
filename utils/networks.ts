...
export const { chains, provider, webSocketProvider } = configureChains(
  [mainnet, arbitrum, { ...bsc, iconUrl: bscIcon }, polygon, goerli, polygonMumbai],
...
export const networks = {
  ...
  [polygonMumbai.id]: {
    ...
    fallbackProviders: {
      chainId: polygonMumbai.id,
      providers: [
        { provider: "https://matic-mumbai.chainstacklabs.com", priority: 1, weight: 1 },
        { provider: getRpcUrl(arbitrum.id), priority: 2, weight: 1 },
      ]
    },
  },
...
export const getNetwork = (chainId: number | undefined = polygonMumbai.id) => {
